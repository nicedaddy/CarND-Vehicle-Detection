# pipeline for training detection model
# search and classify
...
if __name__ == "__main__":    
    # Read in cars and notcars, convert png to [0,255] range
    ...
    # check data type, if validation image is jpg, convert to float32
    ...
    modelname = "Trained_model/"+datenow+"trained_SVM.p"

    # save attributes of our svc object
    dist_pickle = dict()
    dist_pickle["svc"] = svc
